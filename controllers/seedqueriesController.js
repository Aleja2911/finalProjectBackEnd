...
module.exports.seedPart2 = async (req, res, next) => {
    ...
    const scientistsQuery = `
      ...
      ('Tu',	'Youyou',	'Malariologist and Pharmaceutical Chemist',	'{"Chemistry",  "Medicine"}',	'{"Medicine", "Chemistry"}', 'https://en.wikipedia.org/wiki/Tu_Youyou',	'https://cdn.britannica.com/40/187340-050-80EC4AC6/Tu-Youyou.jpg'),
      ...
      ('Dorothy', 	'Vaughan',	'Mathematician',	'{"Mathematics"}',	'{"Understanding the universe"}',	'https://en.wikipedia.org/wiki/Dorothy_Vaughan',	'https://www.thehumancomputerproject.com/files/content/women/dorothy-vaughan_0.jpg'),
