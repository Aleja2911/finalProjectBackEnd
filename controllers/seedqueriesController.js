...
module.exports.seedPart2 = async (req, res, next) => {
    ...
    const scientistsQuery = `
      ...
      ('Lydia',	'Villa-Komaroff',	'Molecular Biology', '{"Biology"}', '{"Materials development"}',	'https://en.wikipedia.org/wiki/Lydia_Villa-Komaroff',	'https://upload.wikimedia.org/wikipedia/commons/thumb/2/24/Lydia_Villa-Komaroff-2.jpg/220px-Lydia_Villa-Komaroff-2.jpg', 'is a molecular and cellular biologist who has been an academic laboratory scientist, a university administrator, and a business woman. She was the third Mexican American woman in the United States to receive a doctorate degree in the sciences (1975) and is a co-founding member of The Society for the Advancement of Chicanos/Hispanics and Native Americans in Science (SACNAS). Her most notable discovery was in 1978 during her post-doctoral research, when she was part of a team that discovered how bacterial cells could be used to generate insulin.'), 
